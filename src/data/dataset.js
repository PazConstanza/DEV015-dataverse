export default [
  {
    "id": "1",
    "name": "Camille",
    "shortDescription": "La Sombra de Acero.", 
    "description": "Camille, conocida como 'La Sombra de Acero', es una luchadora versátil de la línea superior, reconocida por su precisión en los duelos y su capacidad de adaptación. Su kit de habilidades gira en torno a atrapar objetivos con su Gancho y ejecutar daño sostenido con Protocolo de Precisión. Destaca en dividir líneas y atrapar enemigos con su Ultimátum Hextech, convirtiéndola en una fuerza formidable en el late game.",
...

  {
    "id": "20",
    "name": "Shyvana",
    "shortDescription": "La Hija del Dragón.",
